...
class CarRentalAdCardWidget extends StatelessWidget {
  final AdCardModel ad;
  const CarRentalAdCardWidget({super.key, required this.ad});
  ...
  Widget build(BuildContext context) {
    ...
    final driver = ad.attributes['driver_option']?.toString() ??
        ad.attributes['driver']?.toString() ??
        '';
    ...
    if (driver.trim().isNotEmpty) infoLineParts.add(driver.trim());
